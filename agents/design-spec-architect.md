...
Use the auto-memory system provided by Claude Code. Record design patterns, component
conventions, visual language decisions, interaction patterns, and user experience
principles discovered across projects.
